...
public class TextUtility {
  ...
  /**
   * @implNote colorizing then parsing all JSON components of a message by MiniMessage
   */
  @SneakyThrows
  @PaperOnly
  ...
  public IgniteComponent replace(IgniteComponent text, Placeholder... placeholders) {
    for (Placeholder placeholder : placeholders) {
  ...
  public IgniteComponent replace(IgniteComponent text, List<Placeholder> placeholders) {
    for (Placeholder placeholder : placeholders) {
      text = placeholder.replaceIn(text);
    }
    return text;
  ...
  public List<IgniteComponent> replace(
      List<IgniteComponent> text, Placeholder... placeholders) {
    for (Placeholder placeholder : placeholders) {
      text = placeholder.replaceIn(text);
    }
    return text;
   ...
   * @apiNote wrap all integers from string as an array
   */
  ...
  /**
   * Puts color char before every character in a given string. Simply makes this string invisible
   *
