...
package com.ignitedev.igniteSmallUtils.util.collection;
...
public class WeightCollection<E> {
  ...
  /**
   * @param weight of your specified result in argument, higher weight means higher chance;
   *               you cannot specify weight below 0
  ...
  /**
   * @return generate random entry depending on the weight of each item
   */
  public E next() {
